    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, help_text='format: true=product visible', verbose_name='product visibility')),
                ('is_default', models.BooleanField(default=False, help_text='format: true=sub product selected', verbose_name='default selection')),
                ('retail_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 9999.99.'}}, help_text='format: maximum price 9999.99', max_digits=6, verbose_name='recommended retail price')),
                ('store_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 9999.99.'}}, help_text='format: maximum price 9999.99', max_digits=6, verbose_name='regular store price')),
                ('sale_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'the price must be between 0 and 999.99.'}}, help_text='format: maximum price 9999.99', max_digits=6, verbose_name='sale price')),
